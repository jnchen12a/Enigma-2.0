...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.inputTopLayout = QtWidgets.QHBoxLayout()
        self.inputTopLayout.setObjectName('inputTopLayout')
        self.inputTopLayout.addWidget(self.inputTextLabel)
        self.inputTopLayout.addWidget(self.fileButton)
        self.inputTopLayout.addItem(spacerItem)
        ...
        self.inputLayout.addLayout(self.inputTopLayout)
